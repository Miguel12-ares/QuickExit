"""Agregado campo validado a USUARIOS

Revision ID: e6c738aafdae
Revises: 
Create Date: 2025-03-16 17:29:02.717582
...
def upgrade():
    ...
    sa.Column('rol', sa.Enum('aprendiz', 'instructor', 'porteria', 'admin', name='roles_enum'), nullable=False),
    ...
    sa.Column('hora_salida_exacta', sa.Time(), nullable=True),
    sa.Column('hora_reingreso_exacta', sa.Time(), nullable=True),
    ...
    sa.Column('id_administrativo_validador', sa.Integer(), nullable=True),
    sa.Column('id_porteria_registrador', sa.Integer(), nullable=True),
